...
//Ocuppamos almacenar la info del usuario
...
//le pasamos la persona
    ...
    //devuelve lista con objetos granted autority nos dice los roles y permisos de la lista del user
    @Override
    public Collection<? extends GrantedAuthority> getAuthorities(){
        List<GrantedAuthority> authorities = new ArrayList<>();

        //Cada permiso lo agregamos al role 
